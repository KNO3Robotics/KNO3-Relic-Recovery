...
public class NervaRelicSystem extends SubSystem {
    ...
    public NervaRelicSystem(Robot robot) {
        ...
        ClampPosition.DROP.updateSettings(robot);
        ClampPosition.CLUTCH.updateSettings(robot);
    }
    ...
    public void handle() {
        ...
        if(gamepad1().a) {
            setClampState(ClampPosition.CLUTCH);
        }
        ...
        if(gamepad2().x) {
            setClampState(ClampPosition.DROP);
        }
    }
    ...
    public enum ClampPosition {
        ...
        DROP("relic_clamp_drop"),
        CLUTCH("relic_clamp_clutch");
