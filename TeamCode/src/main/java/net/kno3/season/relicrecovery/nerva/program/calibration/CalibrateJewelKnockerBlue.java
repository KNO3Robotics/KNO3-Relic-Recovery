...
public class CalibrateJewelKnockerBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            double idleSetPoint = settings.getDouble("jewel_knocker_blue_idle");
            while(opModeIsActive() && !gamepad1.a) {
                if(Math.abs(gamepad1.left_stick_x) > 0.05) {
            ...
            double initSetPoint = settings.getDouble("jewel_knocker_blue_init");
            while(opModeIsActive() && !gamepad1.a) {
                if(Math.abs(gamepad1.left_stick_x) > 0.05) {
            ...
            settings.setDouble("jewel_knocker_blue_idle", idleSetPoint);
            settings.setDouble("jewel_knocker_blue_init", initSetPoint);
            settings.save();
