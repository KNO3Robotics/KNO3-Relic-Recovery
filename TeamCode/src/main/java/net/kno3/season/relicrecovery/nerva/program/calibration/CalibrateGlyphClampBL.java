...
public class CalibrateGlyphClampBL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            double autoSetpoint = settings.getDouble("glyph_clamp_bottom_left_auto");
            while(opModeIsActive() && !gamepad1.a) {
                if(Math.abs(gamepad1.left_stick_x) > 0.05) {
                ...
                bottomLeftGlyphClamp.setPosition(autoSetpoint);
            ...
            settings.setDouble("glyph_clamp_bottom_left_auto", autoSetpoint);
            settings.save();
