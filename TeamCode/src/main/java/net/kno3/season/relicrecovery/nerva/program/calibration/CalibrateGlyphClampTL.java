...
public class CalibrateGlyphClampTL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            double autoSetpoint = settings.getDouble("glyph_clamp_top_left_auto");
            while(opModeIsActive() && !gamepad1.a) {
                if(Math.abs(gamepad1.left_stick_x) > 0.05) {
                ...
                topLeftGlyphClamp.setPosition(autoSetpoint);
            ...
            settings.setDouble("glyph_clamp_top_left_auto", autoSetpoint);
            settings.save();
