...
public class NervaGlyphSystem extends SubSystem {
    ...
    public NervaGlyphSystem(Robot robot) {
        ...
        BottomClampState.AUTO.updateSettings(robot);
        ...
        TopClampState.AUTO.updateSettings(robot);
    ...
    public void handle() {
        ...
        if (!dpadDownLock && gamepad2().dpad_down) {
            if(bottomClampState != BottomClampState.CLOSED) {
                botState = BottomClampState.CLOSED;
            } else {
    ...
    public void setLiftPower(double power) {
        if(getLiftEnc() <= 0 && power > 0 && !(gamepad2().left_trigger > 0.7)) {
            power = 0;
        }
        if(getLiftEnc() > 4750 && power < 0 && !(gamepad2().left_trigger > 0.7)) {
            power = 0;
        }
    ...
    public enum BottomClampState {
        ...
        AUTO("glyph_clamp_bottom_left_auto", "glyph_clamp_bottom_right_auto");
    ...
    public enum TopClampState {
        ...
        AUTO("glyph_clamp_top_left_auto", "glyph_clamp_top_right_auto");
