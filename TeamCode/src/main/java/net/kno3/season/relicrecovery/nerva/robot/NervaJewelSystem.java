...
public class NervaJewelSystem extends SubSystem {
    ...
    public NervaJewelSystem(Robot robot) {
        ...
        KnockerPosition.INIT.updateSettings(robot);
        KnockerPosition.IDLE.updateSettings(robot);
    }
    ...
    public void init() {
        ...
        setRedKnocker(KnockerPosition.INIT);
    ...
    public enum KnockerPosition {
        ...
        INIT("jewel_knocker_red_init", "jewel_knocker_blue_init"),
        IDLE("jewel_knocker_red_idle", "jewel_knocker_blue_idle");
