...
public class Nerva extends Robot {
    ...
    public static final String IMU_1_KEY = "imuback";
    public static final String IMU_2_KEY = "imuside";
    public static final String ENCODER_X_KEY = "encX";
    public static final String ENCODER_Y_KEY = "encY";
    public static final String COLOR_LEFT_KEY = "left color";
    public static final String COLOR_RIGHT_KEY = "right color";
    ...
    public static final String JEWEL_SENSOR_RIGHT_KEY = "Right Jewel Color";
