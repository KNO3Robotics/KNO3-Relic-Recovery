...
@Autonomous(name = "Red Audience 3 Glyph")
public class RedAutoAudience3G extends NervaAutoRed {
    private VuforiaScanner vuforiaScanner;
    private double displace = 0;
    ...
    public void main() {
        ...
        jewelSys.setLeftArm(NervaJewelSystem.ArmPosition.CENTER);
        waitFor(.1);
        jewelSys.setRedKnocker(NervaJewelSystem.KnockerPosition.IDLE);
        waitFor(.1);
